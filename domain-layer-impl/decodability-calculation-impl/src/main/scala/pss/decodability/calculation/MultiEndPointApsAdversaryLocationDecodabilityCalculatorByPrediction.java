...
public class MultiEndPointApsAdversaryLocationDecodabilityCalculatorByPrediction implements AdversaryEndPointDecodabilityCalculable<LocationDecodabilityResult, AdversaryResultWithSingleOcTable> {
    ...
    public MultiEndPointApsAdversaryLocationDecodabilityCalculatorByPrediction(ApsAdversary apsAdversary, ValueMap valueMap, PssVariables pssVariables, PssType pssType, Set<PssGroup> pssGroups, OoiUserGroupMappable ooiUserGroupMapper, List<ObservedReport> observedReports, List<FinalReport> finalReports, OcTable adversaryOcTable) {
