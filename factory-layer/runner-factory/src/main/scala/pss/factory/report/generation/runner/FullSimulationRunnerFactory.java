...
import pss.runner.FullSimulationRunner;
...
public class FullSimulationRunnerFactory {
    public static FullSimulationRunner generateFullSimulationRunner(FullSimulationRunnerConfig runnerConfig, long runnerSeed, String resultDirectory) throws RunnerCreationException, InvalidConfigException, PssException, ReaderException {
