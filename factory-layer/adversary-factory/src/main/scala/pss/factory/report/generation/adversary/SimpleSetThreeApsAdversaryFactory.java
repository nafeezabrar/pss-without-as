...
public class SimpleSetThreeApsAdversaryFactory implements MultipleAdversaryFactory {
    ...
    public SimpleSetThreeApsAdversaryFactory(ReportFilter reportFilter, DeanonymizationMethod deanonymizationMethod, MyRandom myRandom) {
    ...
    public List<Adversary> createAdversaries(List<FinalReport> finalReports, Set<User> users, ReportFilteringConfig reportFilteringConfig, PssType pssType) throws PssException {
        ...
        Set<Set<Integer>> combinations = CombinatoricsUtility.getCombinations(userIdSet, 3);
