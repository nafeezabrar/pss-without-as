...
public class JsonFullSimulationTillDecodingRunnerConfigReader extends JsonConfigReader implements FullSimulationTillDecodingRunnerConfigReadable {
    public JsonFullSimulationTillDecodingRunnerConfigReader(String fileName) throws ReaderException {
        super(fileName);
    }

    @Override
    public FullSimulationTillDecodingRunnerConfig generateFullSimulationTillDecodingRunnerConfig() throws InvalidConfigException, ReaderException, PssException {
