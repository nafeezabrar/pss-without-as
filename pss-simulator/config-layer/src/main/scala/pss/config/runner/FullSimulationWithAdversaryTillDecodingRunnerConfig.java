...
import static pss.config.runner.RunnerType.FULL_SIMULATION_WITH_ADVERSARY_TILL_DECODING;

public class FullSimulationWithAdversaryTillDecodingRunnerConfig extends RunnerConfig {
