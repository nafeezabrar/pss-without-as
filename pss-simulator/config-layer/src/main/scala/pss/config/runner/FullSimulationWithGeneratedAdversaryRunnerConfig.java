...
import static pss.config.runner.RunnerType.FULL_SIMULATION_WITH_GENERATED_ADVERSARY;

public class FullSimulationWithGeneratedAdversaryRunnerConfig extends RunnerConfig {
