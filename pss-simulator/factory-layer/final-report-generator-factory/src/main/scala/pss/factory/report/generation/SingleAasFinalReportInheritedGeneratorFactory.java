...
import pss.report.generation.SingleFinalAasReportGenerator;

public class SingleAasFinalReportInheritedGeneratorFactory implements FinalReportInheritedGeneratorFactory<SingleOoiUserGroupMappable> {
    @Override
    public FinalReportInheritedGenerable generateFinalReportGenerator(long runnerSeed, PssVariables pssVariables, SingleOoiUserGroupMappable ooiUserGroupMapper) throws PssException {
        ...
        return new SingleFinalAasReportGenerator(myRandom, pssVariables, ooiUserGroupMapper);
    }
}
