...
import pss.report.generation.MultiFinalAasReportGenerator;

public class MultiAasFinalReportInheritedGeneratorFactory implements FinalReportInheritedGeneratorFactory<MultiOoiUserGroupMappable> {
    ...
    public FinalReportInheritedGenerable generateFinalReportGenerator(long runnerSeed, PssVariables pssVariables, MultiOoiUserGroupMappable ooiUserGroupMapper) throws PssException {
        ...
        return new MultiFinalAasReportGenerator(myRandom, pssVariables, ooiUserGroupMapper);
    }
}
