...
import pss.runner.FullSimulationWithAdversaryTillDecodingRunner;
...
public class FullSimulationWithAdversaryTillDecodingRunnerFactory {
    public static FullSimulationWithAdversaryTillDecodingRunner generateFullSimulationWithAdversaryTillDecodingRunner(FullSimulationWithAdversaryTillDecodingRunnerConfig runnerConfig, long runnerSeed, String resultDirectory) throws RunnerCreationException, InvalidConfigException, PssException, ReaderException {
