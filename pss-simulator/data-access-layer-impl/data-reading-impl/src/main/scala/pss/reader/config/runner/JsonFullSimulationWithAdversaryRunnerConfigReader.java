...
public class JsonFullSimulationWithAdversaryRunnerConfigReader extends JsonConfigReader implements FullSimulationWithAdversaryRunnerConfigReadable {
    public JsonFullSimulationWithAdversaryRunnerConfigReader(String fileName) throws ReaderException {
        super(fileName);
    }

    @Override
    public FullSimulationWithAdversaryRunnerConfig generateFullSimulationWithAdversaryRunnerConfig() throws InvalidConfigException, ReaderException, PssException {
