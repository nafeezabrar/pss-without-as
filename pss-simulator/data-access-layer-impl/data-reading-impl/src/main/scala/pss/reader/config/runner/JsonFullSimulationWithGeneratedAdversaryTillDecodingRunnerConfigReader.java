...
public class JsonFullSimulationWithGeneratedAdversaryTillDecodingRunnerConfigReader extends JsonConfigReader implements FullSimulationWithGeneratedAdversaryTillDecodingRunnerConfigReadable {
    public JsonFullSimulationWithGeneratedAdversaryTillDecodingRunnerConfigReader(String fileName) throws ReaderException {
        super(fileName);
    }

    @Override
    public FullSimulationWithGeneratedAdversaryTillDecodingRunnerConfig generateFullSimulationWithGeneratedAdversaryTillDecodingRunnerConfig() throws InvalidConfigException, ReaderException, PssException {
