...
public class SingleRasOcTableUpdater implements AasIocTableUpdatable<SingleAnonymizedLocalOoiSet, SingleRasAnonymity> {
    ...
    public SingleRasOcTableUpdater(SingleOcTable ocTable, SingleLocalOoiCollection localOoiCollection, MyRandom myRandom) {
    ...
    @Override
    public SingleAnonymizedLocalOoiSet getAnonymizedOois(Value value, SingleRasAnonymity anonymity) {
        ...
        int remaining = anonymity.getAnonymity();
