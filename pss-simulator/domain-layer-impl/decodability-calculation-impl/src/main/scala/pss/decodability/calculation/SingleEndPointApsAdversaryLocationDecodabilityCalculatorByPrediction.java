...
public class SingleEndPointApsAdversaryLocationDecodabilityCalculatorByPrediction implements AdversaryEndPointDecodabilityCalculable<LocationDecodabilityResult, AdversaryResultWithSingleOcTable> {
    ...
    public SingleEndPointApsAdversaryLocationDecodabilityCalculatorByPrediction(ApsAdversary apsAdversary, ValueMap valueMap, PssVariables pssVariables, PssType pssType, Set<PssGroup> pssGroups, OoiUserGroupMappable ooiUserGroupMapper, List<ObservedReport> observedReports, List<FinalReport> finalReports, OcTable adversaryOcTable) {
    ...
    private LocationOoi getLocationOoi(ObservedReport observedReport) throws PssException {
        ...
        LocationOoi locationOoi = (LocationOoi) ooiUserGroupMapper.getOoi(localLocationOoi, userId);
        return locationOoi;
    }
