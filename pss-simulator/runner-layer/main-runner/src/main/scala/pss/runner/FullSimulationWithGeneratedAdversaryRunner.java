...
public class FullSimulationWithGeneratedAdversaryRunner implements PssRunnable {
    ...
    protected final MultipleAdversaryFactory adversaryFactory;
    ...
    public FullSimulationWithGeneratedAdversaryRunner(PssType pssType, PssVariableGenerable pssVariableGenerator, PssGroupable pssGrouper, UserGenerable userGenerator, UserGroupable userGrouper, OoiUserGroupMapperFactory ooiUserGroupMapperFactory, AnonymizerFactory anonymizerFactory, DeanonymizerSetFactory deanonymizerSetFactory, OoiGroupMapperCreatorFactory ooiGroupMapperCreatorFactory, AnonymizerSelectorFactory anonymizerSelectorFactory, DeanonymizerSelectorFactory deanonymizerSelectorFactory, ObservedReportSetGenerable observedReportGenerator, AnonymizableReportGenerable anonymizableReportGenerator, FinalReportInheritedGeneratorFactory finalReportGeneratorFactory, AnonymityGenerable anonymityGenerator, FullCycleRunnerFactory fullCycleRunnerFactory, MultipleAdversaryFactory adversaryFactory, AdversaryRunnerFactory adversaryRunnerFactory, FullSimulationPostResultAnalyzer postResultAnalyzer, FullSimulationWithAdversaryPostResultAnalyzer postResultAnalyzerWithAdversary, ReportFilteringConfig reportFilteringConfig) {
        ...
        this.postResultAnalyzerWithAdversary = postResultAnalyzerWithAdversary;
    ...
    public void run() throws Exception {
        ...
        List<FinalReport> finalReports = getFinalReports(fullCycleResults);
        ...
        List<Adversary> adversaries = adversaryFactory.createAdversaries(finalReports, userMapper.getUsers(), reportFilteringConfig, pssType);
    ...
    private List<FinalReport> getFinalReports(List<FullCycleResult> fullCycleResults) {
